...
public class TimeUtil {
    ...
    public static final String DATE_FOMATE_YYYY_MM_DDHHMM = "yyyy-MM-dd HH:mm";

    public static final String DATE_FOMATE_YYYY_MM_DDHH = "yyyy-MM-dd HH";

    public static final String DATE_FOMATE_YYYY_MM_DDHH00 = "yyyy-MM-dd HH:00";

    public static final String DATE_FOMATE_YYYY_MM_DD = "yyyy-MM-dd";

    public static final String DATE_FOMATE_YYYY_MM = "yyyy-MM";

    public static final String DATE_FOMATE_YYYY_MM_DDHHMMSS_START = "yyyy-MM-dd 00:00:00";

    public static final String DATE_FOMATE_YYYY_MM_DDHHMMSS_END = "yyyy-MM-dd 23:59:59";
